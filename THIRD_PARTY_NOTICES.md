...
respin release archives may include dynamically linked Qt 6 Core and Qt 6 Network
runtime libraries. Qt is copyright The Qt Company Ltd. and other contributors
and is not licensed under respin's Apache-2.0 license.
...
distributor's commercial agreement. respin does not change or replace those terms.

When the source Qt installation provides a `LICENSES` directory, respin's CMake
packaging installs it under `share/doc/respin/third-party/qt`. Distribution
...
Other system libraries are not copied into the respin Linux archive. They are
